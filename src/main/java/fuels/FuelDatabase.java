...
public class FuelDatabase {
    ...
    public static class FuelParameters {
        ...
        FuelParameters(double _energyPerMass, double _density){
    ...
    public static void addNewFuel(String name, FuelParameters parameters){
        if (checkFuelDefined(name)){
            System.err.println("Trying to add already defined fuel to the fuel database.");
        } else {
